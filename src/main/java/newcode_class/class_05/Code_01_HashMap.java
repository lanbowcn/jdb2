package newcode_class.class_05;
...
public class Code_01_HashMap {
	...
	public static void main(String[] args) {
		...
		// you can not remove item in mapTest when you use the iterator of mapTest
//		 for(Entry<StringTest,StringTest> entry : mapTest.entrySet()){
